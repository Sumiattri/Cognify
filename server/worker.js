...
// --- The most common and robust way to import PDFLoader for Node.js (accepts Blob/Buffer) ---
import { PDFLoader } from "@langchain/community/document_loaders/fs/pdf";
...
const worker = new Worker(
  ...
  async (job) => {
    try {
      ...
      // --- CRITICAL CHANGE: Fetch the PDF content as a Blob ---
      ...
      const pdfBlob = await response.blob(); // Get the content as a Blob

      // --- Use the PDFLoader from 'fs/pdf' with the fetched Blob ---
